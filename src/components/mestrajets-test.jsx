                ...
                {selectedJourney && (
                    <>
                        ...
                        <div
                            ...
                            // La style prop du panneau Détails — remplacer l'actuel style={{ height: ... }} :
                            style={{
                            ...
                            <div
                                ...
                                onPointerUp={() => {
                                    if (dragStartY.current !== null) {
                                        ...
                                        if (delta < -2) {
                                            // Drag vers le haut → snap à 90vh
                                            setDetailsHeight(90);
                                        } else if (origin >= 80) {
                                            // On était à 90vh, drag vers le bas → revenir à 60vh
                                            if (delta > 5) setDetailsHeight(60);
                                            else setDetailsHeight(90);
                                        } else {
                                            // On était à 60vh, drag vers le bas → fermer
                    ...
                    <div className="space-y-3">
                        ...
                        <button
                            onClick={() => {
                                setTrajets(prev => ({
                                    ...prev,
                                    [currentTrajet]: { ...prev[currentTrajet], name: newTrajetName.trim() || { T1: 'Trajet 1', T2: 'Trajet 2', T3: 'Trajet 3' }[currentTrajet] }
                                }));
                                setRenameOpen(false);
                                setInputsOpen(inputsOpenBeforeRenameRef.current);
                            }}
